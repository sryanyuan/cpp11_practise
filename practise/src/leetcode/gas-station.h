#ifndef _INC_GAS_STATION_
#define _INC_GAS_STATION_
...
public:
	static void test() {
        int gass[] = {1,2,3,4,5};
        int costs[] = {3,4,5,1,2};
		vector<int> gas(gass, gass + sizeof(gass) / sizeof(gass[0]));
        vector<int> cost(costs, costs + sizeof(costs) / sizeof(costs[0]));
